            ...
            <div class="relative">
                <header class="border-b border-slate-200/70 bg-white/70 backdrop-blur">
                    <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
                        ...
                        <div class="flex items-center gap-3">
                            <a class="rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:border-slate-400" href="#">Entrar</a>
                            <a class="rounded-full bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800" href="#">Nou projecte</a>
                        </div>
                    </div>
                </header>
